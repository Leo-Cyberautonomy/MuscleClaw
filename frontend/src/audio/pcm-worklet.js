...
class PCMProcessor extends AudioWorkletProcessor {
  process(inputs) {
    ...
    // VAD (voice activity detection) is now handled server-side via
    // RealtimeInputConfig.automatic_activity_detection with LOW sensitivity.
    // No client-side silence gate needed.
